...
const modify = (searchStr: string, replaceStr: string) => {
...
modify(
  ...
  `className={\`px-4 py-2 bg-[#0b0b14]/90 backdrop-blur-md border flex items-center justify-center gap-2 rounded-xl shadow-lg cursor-pointer transition-all active:scale-95 backdrop-blur-md \${
                chatOpen ? 'border-green-500/50 text-green-400 bg-green-500/10 shadow-[0_0_15px_rgba(34,197,94,0.3)]' : 'border-white/10 hover:border-white/30 text-white hover:bg-white/5 ring-1 ring-inset ring-white/5'
              }\`}`
);
