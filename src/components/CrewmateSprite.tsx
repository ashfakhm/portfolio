...
export type { CrewmateColor, CrewmateHat };
...
function Hat({ hat, direction }: { hat: CrewmateHat; direction: "left" | "right" }) {
	switch (hat) {
		case "sticky":
			return (
				<g
					transform={`translate(${direction === "right" ? "18" : "10"}, -10)`}
					className="origin-bottom"
				>
					{/* Sticky Yellow Square */}
					<path
						d="M 0 0 L 16 0 L 16 14 L 3 14 L 0 11 Z"
						fill="#FFE14C"
						stroke="#000000"
						strokeWidth="2.5"
					/>
					<path
						d="M 0 11 L 3 11 L 3 14"
						fill="#E0C233"
						stroke="#000000"
						strokeWidth="2.5"
					/>
		...
		case "plant":
			return (
				<g
					transform={`translate(${direction === "right" ? "21" : "15"}, -14)`}
				>
					{/* Sprout stem */}
					<path
						d="M 5 14 Q 5 10 2 6 Q 0 4 -2 5"
						fill="none"
						stroke="#228B22"
						strokeWidth="3.5"
						strokeLinecap="round"
					...
					{/* Left leaf */}
					<path
						d="M 2 6 C 0 3 -4 2 -6 6 C -5 9 -1 8 2 6"
						fill="#4CD137"
						stroke="#000000"
						strokeWidth="2"
					/>
					{/* Right leaf */}
					<path
						d="M 2 6 C 5 3 9 2 11 6 C 10 9 6 8 2 6"
						fill="#4CD137"
						stroke="#000000"
						strokeWidth="2"
					/>
		...
		case "egg":
			return (
				<g
					transform={`translate(${direction === "right" ? "12" : "8"}, -12)`}
				>
					{/* White egg pancake */}
					<path
						d="M -4 10 Q -6 6 0 5 Q 7 3 12 5 Q 18 6 16 10 Q 14 13 8 13 Q -2 13 -4 10 Z"
						fill="#FFFFFF"
						stroke="#000000"
						strokeWidth="2.5"
					/>
		...
		case "crown":
			return (
				<g
					transform={`translate(${direction === "right" ? "12" : "8"}, -15)`}
				>
					{/* Gold Crown */}
					<path
						d="M 0 10 L 0 2 L 4 6 L 8 1 L 12 6 L 16 2 L 16 10 Z"
						fill="#F1C40F"
						stroke="#000000"
						strokeWidth="2.5"
					/>
		...
		case "pompom":
			return (
				<g
					transform={`translate(${direction === "right" ? "22" : "14"}, -24)`}
				>
					{/* Balloon string */}
					<path
						d="M 0 24 Q -2 16 0 10"
						fill="none"
						stroke="#2c3e50"
						strokeWidth="2"
					/>
		...
		case "toilet":
			return (
				...
				>
					...
					{/* Trailing paper */}
					<path
						d="M 0 11 Q -5 14 -7 20 Q -4 21 -2 20 Q 0 15 0 11 Z"
						fill="#FFFFFF"
						stroke="#000000"
						strokeWidth="1.5"
					/>
		...
		case "viking":
			return (
				<g
					transform={`translate(${direction === "right" ? "12" : "6"}, -11)`}
				>
					{/* Dome helmet */}
					<path
						d="M -2 10 A 10 10 0 0 1 18 10 Z"
						fill="#7F8C8D"
						stroke="#000000"
						strokeWidth="2.5"
					/>
					{/* Left horn */}
					<path
						d="M -2 7 Q -10 4 -12 -3 Q -6 -2 -2 5 Z"
						fill="#FDFEFE"
						stroke="#000000"
						strokeWidth="2"
					/>
					{/* Right horn */}
					<path
						d="M 18 7 Q 26 4 28 -3 Q 22 -2 18 5 Z"
						fill="#FDFEFE"
						stroke="#000000"
						strokeWidth="2"
					/>
		...
		case "chef":
			return (
				<g
					transform={`translate(${direction === "right" ? "12" : "8"}, -18)`}
				>
					{/* Puffy Chef Hat */}
					<path
						d="M 0 16 F 0 10 Q -4 8 -2 5 Q 0 0 8 2 Q 16 0 18 5 Q 20 8 16 10 L 16 16 Z"
						fill="#FFFFFF"
						stroke="#000000"
						strokeWidth="2.5"
					/>
		...
		>
          ...
          `}</style>
				...
				<g className={legCycleClass2}>
					...
					<path
						d="M 21 34 Q 26 38 31 34 L 31 37 Q 26 39 21 37 Z"
						fill={selectedColor.shadow}
					/>
				</g>
				...
				<Hat hat={hat} direction={direction} />
			</svg>
		</div>
	);
}
