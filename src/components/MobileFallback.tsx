export default function MobileFallback() {
	return (
		<div className="fixed inset-0 bg-[#07070F] z-100 flex flex-col items-center justify-center p-8 text-center select-none animate-fadeIn">
			...
			<h2 className="text-brand-cyan text-sm font-bold uppercase tracking-widest mb-3 font-mono">
				Desktop Recommended
			</h2>
			<p className="text-[10px] text-slate-400 max-w-xs leading-relaxed font-mono uppercase tracking-widest">I am currently working on the mobile responsive layout. For now, please
