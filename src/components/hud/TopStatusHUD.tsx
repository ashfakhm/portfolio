...
export function TopStatusHUDView({
	progressPercent,
	completedCount,
	totalTasks,
	onHelpClick,
	...
	return (
		<div className="w-full max-w-2xl mx-auto pointer-events-auto bg-hud-bg/90 backdrop-blur-md border border-white/10 p-2 sm:p-2.5 rounded-2xl flex flex-col space-y-2 shadow-[0_8px_32px_rgba(0,0,0,0.5)] ring-1 ring-inset ring-white/5">
			...
			<div className="w-full h-3.5 bg-black border border-border-subtle rounded overflow-hidden p-0.5 relative">
				<div
