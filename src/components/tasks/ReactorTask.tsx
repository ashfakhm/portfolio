...
export default function ReactorTask({
	onComplete,
	isCompleted,
}: ReactorTaskProps) {
	const { reactorPower, handleReactorAlignment } = useReactorTask({
		onComplete,
	});
			...
			{!isCompleted ? (
				<div className="flex-1 flex flex-col items-center justify-center text-center space-y-6">
					...
					<div className="max-w-md space-y-2">
						<h3
							className="text-[10px] sm:text-xs md:text-base font-bold text-yellow-400 px-2"
							style={{ fontFamily: '"Press Start 2P"' }}
						>
							STABILIZE REACTOR UNIT
						</h3>
						<p className="text-xs text-gray-400 leading-relaxed">
							Core temperature is fluctuating! Slide the lever to 100% manual
							power output to lock in the "Who I Am" bio logs.
						</p>
					</div>
					...
					<div className="w-full max-w-sm space-y-3">
						<div className="flex items-center justify-between text-xs text-gray-400 font-bold mb-1">
							...
							<span
								className={
									reactorPower === 100 ? "text-green-400" : "text-yellow-400"
								}
							>
				...
				<div className="flex-1 flex flex-col gap-4 animate-fadeIn">
					<div className="border-2 border-green-500/40 bg-[#122c1b]/30 p-3 rounded flex items-center gap-3">
						<div className="p-1 px-2.5 bg-green-950 rounded text-green-400 text-xs font-bold border border-green-500">
							ONLINE
						</div>
						<span className="text-[10px] sm:text-xs font-mono text-green-400 break-words">
							REACTOR SYSTEMS STATUS: OPTIMAL COOLDOWN ACTIVE.
						</span>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-5 gap-4">
						<div className="md:col-span-2 bg-[#1a1a2e] border-2 border-[#3a3a5e] p-4 rounded-lg flex flex-col justify-between">
							<div className="space-y-4">
								<h4 className="text-xs text-[#1a9eff] font-bold uppercase tracking-wider">
									CREWMATE DOSSIER
								</h4>
							...
							<div
								className="pt-4 border-t border-[#3a3a5e] space-y-2 text-[10px]"
						...
						<div className="md:col-span-3 bg-[#111122] border border-[#3a3a5e] p-5 rounded-lg space-y-4">
							<div className="flex items-center gap-2">
								...
								<h4 className="text-sm font-bold text-white uppercase tracking-wide">
									Developer Bio & Missions
								</h4>
							</div>

							<div className="text-xs text-slate-300 leading-relaxed space-y-3">
								<p>
									I'm Ashfakh, a Full Stack Developer located in Malappuram,
									Kerala. I specialize in building blazing fast React based web
									architectures and bulletproof backend models that don't crack
									under heavy volumes.
								</p>
								<p>
								...
								<p>
									...
									of 2026). I code every single hour of my day, keeping modern
									stack standards inside my head.
								</p>
							</div>

							<div className="bg-[#1c1c38]/40 p-3 rounded border border-[#3a3a5e] text-[11px] text-[#38FEDE]">
								"Committed to delivering pristine UI performance (100 SEO & 90+
								Lighthouse Core Web Vitals) alongside optimal server latency."
							</div>
						</div>
					</div>
				</div>
