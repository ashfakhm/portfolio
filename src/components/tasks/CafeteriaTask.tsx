import CrewmateSprite, { type CrewmateColor } from "../CrewmateSprite";
...
export default function CafeteriaTask({
	onComplete,
	playerColor,
}: CafeteriaTaskProps) {
	...
	return (
		<div className="flex-1 flex flex-col md:flex-row gap-6 items-center justify-center p-2 animate-fadeIn">
			<div className="flex flex-col items-center justify-center py-4 bg-[#1a1a2e] border-2 border-[#3a3a5e] p-6 rounded-lg w-full md:w-5/12 text-center relative overflow-hidden">
				<div className="absolute top-2 left-2 rotate-[5deg] bg-red-600 px-2 py-0.5 text-[8px] rounded font-bold animate-pulse">
					YOU
				</div>
			...
			<div className="flex-1 space-y-4 max-w-md">
				<div className="bg-[#0D0D1A] p-4 rounded-lg border-2 border-[#1a9eff]/30 space-y-2">
					<h3 className="text-xs text-[#1a9eff] font-bold tracking-widest uppercase">
						GREETINGS CREWMATE!
					</h3>
					...
					<p className="text-xs text-slate-300 leading-relaxed pt-2">
						...
						and rock-solid Node/FastAPI servers designed to sustain warp load
						speeds."
					</p>
				</div>
				...
				<div className="grid grid-cols-2 gap-3 text-xs">
					<div className="border border-[#3a3a5e] p-2.5 rounded bg-[#10101a] flex flex-col">
						...
						<span className="text-gray-400 text-[9px] mt-0.5">
							Farook College ('26)
						</span>
					</div>
					<div className="border border-[#3a3a5e] p-2.5 rounded bg-[#10101a] flex flex-col">
						<span className="text-gray-500 text-[10px]">TRUST METRIC</span>
						<span className="text-green-400 font-medium truncate mt-0.5">
							100 SEO Score
						</span>
						<span className="text-gray-400 text-[9px] mt-0.5">
							Chrome Lighthouse Verified
						</span>
					</div>
				</div>
