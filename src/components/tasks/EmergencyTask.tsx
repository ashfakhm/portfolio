...
export default function EmergencyTask({
	onComplete,
	playerColor,
}: EmergencyTaskProps) {
	const {
					...
					<div className="flex-1 flex flex-col items-center justify-center text-center p-6 space-y-4 animate-fadeIn">
						<div className="p-4 bg-green-950/20 border border-green-500/30 rounded-lg max-w-md">
							...
							<p className="text-xs text-gray-300 leading-normal">
								Thank you for submitting! Your report has bypassed firewall
								protocols and landed securely in ashfakhthedev@gmail.com inbox
								logs.
							</p>
