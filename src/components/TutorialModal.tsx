						...
						<div className="space-y-3 text-left">
									...
									{isMobileDevice ? (
										<ul className="list-disc pl-4 space-y-1 text-[9px] text-slate-400">
											<li>
												...
												Drag the bottom-left stick.
											</li>
											<li>
												<strong className="text-slate-200">
													Autopilot Click:
												</strong>{" "}
												Tap floor map to auto-run.
											</li>
											<li>
												<strong className="text-slate-200">HUD Nav:</strong> Tap
												any mission in top-left list.
											</li>
										</ul>
									) : (
										<ul className="list-disc pl-4 space-y-1 text-[9px] text-slate-400">
											<li>
												<strong className="text-slate-200">Move:</strong>{" "}
											...
											<li>
												<strong className="text-slate-200">Map:</strong>{" "}
												<kbd className="px-1 bg-slate-900 border border-slate-700 rounded text-white">
													M
												</kbd>{" "}
												or{" "}
											...
											<li>
												...
												Click floor map to run.
											</li>
											<li>
												<strong className="text-slate-200">HUD Nav:</strong>{" "}
												Click mission list top-left.
											</li>
										</ul>
									)}
								</div>
								...
								<div className="flex-1">
									...
									<ul className="list-disc pl-4 space-y-1 text-[9px] text-slate-400">
										...
										<li>
											...
											Don't close early or it resets! Press{" "}
											<kbd className="px-1 bg-slate-900 border border-slate-700 rounded text-white">
												ESC
											</kbd>{" "}
											to close tasks.
							...
							<div className="bg-[#141724] border border-slate-700 p-2.5 rounded space-y-1.5 flex gap-2.5">
								...
								<div className="flex-1">
									...
									<ul className="list-disc pl-4 space-y-1 text-[9px] text-slate-400">
										<li>
											<strong className="text-slate-200">Fast Travel:</strong>{" "}
											Use secret passages via{" "}
											<kbd className="px-1 bg-slate-900 border border-slate-700 rounded text-white">
												V
											</kbd>{" "}
											or <strong className="text-sky-400">PASSAGE</strong>{" "}
											button. Press{" "}
											<kbd className="px-1 bg-slate-900 border border-slate-700 rounded text-white">
												ESC
											</kbd>{" "}
										...
										<li>
											<strong className="text-slate-200">Report:</strong> Tap
											Cafeteria red table button to contact.
										</li>
									</ul>
								</div>
							</div>
