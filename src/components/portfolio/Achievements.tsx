export default function Achievements() {
	return (
		<div className="flex-1 flex flex-col gap-4 animate-fadeIn">
			<div className="bg-amber-500/5 backdrop-blur-md border border-amber-500/20 shadow-[0_0_20px_rgba(245,158,11,0.15)] p-4 rounded-xl flex items-center justify-between">
			...
			<div className="grid grid-cols-1 gap-4 flex-1 mt-2">
				{/* Achievements Item 1 */}
				<div className="bg-[#12121e]/90 backdrop-blur-xl border border-white/5 rounded-2xl p-6 hover:border-amber-500/40 hover:bg-modal-bg transition-colors duration-300 group shadow-lg shadow-amber-900/10 flex flex-col justify-between">
				...
				<a
					...
					className="bg-[#12121e]/90 backdrop-blur-xl border border-white/5 rounded-2xl p-6 hover:border-cyan-500/40 hover:bg-modal-bg transition-colors duration-300 group shadow-lg shadow-cyan-900/10 flex flex-col justify-between cursor-pointer"
				>
					<div className="space-y-4">
						<div className="flex items-center gap-3 mb-2">
							<span className="text-2xl transform group-hover:scale-110 transition-transform">
