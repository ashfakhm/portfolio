    ...
    <div className="flex-1 flex flex-col gap-4 animate-fadeIn">
      <div className="bg-amber-500/5 backdrop-blur-md border border-amber-500/20 shadow-[0_0_20px_rgba(245,158,11,0.15)] p-4 rounded-xl shadow-lg border-l-4 border-l-amber-500 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="font-bold text-amber-400 font-mono tracking-widest text-sm">ARCHIVE RECORDS OPENED</span>
        </div>
        ...
        >
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2 text-[10px] font-mono mt-4">
              ...
              <span className="px-2.5 py-1 bg-white/10 text-slate-100 rounded-md font-mono border border-white/20 shadow-sm">UI/UX</span>
              <span className="px-2 py-1 bg-cyan-500/10 rounded text-cyan-400 border border-cyan-500/20">Verify 1NT0M98IZUEU ↗</span>
            </div>
          </div>
