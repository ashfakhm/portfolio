...
export default function DegreeCerts() {
	return (
		<div className="flex-1 flex flex-col gap-4 animate-fadeIn">
			<div className="bg-emerald-500/5 backdrop-blur-md border border-emerald-500/20 shadow-[0_0_20px_rgba(16,185,129,0.15)] p-4 rounded-xl flex items-center justify-between">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1 mt-2">
				{/* Education Card */}
				<div className="bg-[#12121e]/90 backdrop-blur-xl border border-white/5 rounded-2xl p-6 hover:border-emerald-500/40 hover:bg-modal-bg transition-colors duration-300 group shadow-lg shadow-emerald-900/10 flex flex-col justify-between">
					<div className="space-y-4">
						<div className="flex items-center gap-4 border-b border-white/5 pb-4">
							...
							<div>
								...
								<h3 className="text-base font-bold text-white tracking-widest font-mono mt-1 group-hover:text-emerald-400 transition-colors">
									Farook College
								</h3>
							</div>
						</div>
						...
						<div className="grid grid-cols-1 gap-3 pt-2 text-xs text-slate-300 font-mono">
							...
							<div className="flex flex-col">
								<span className="text-gray-500 text-[10px]">
									CORE STUDIES REDACTED
								</span>
								<span className="text-white mt-0.5">
									Data Structures & Algorithms · DBMS · OS · Distributed Systems
								</span>
							</div>
						</div>
					</div>
				...
				<a
					...
					className="bg-[#12121e]/90 backdrop-blur-xl border border-white/5 rounded-2xl p-6 hover:border-blue-500/40 hover:bg-modal-bg transition-colors duration-300 group shadow-lg shadow-blue-900/10 flex flex-col justify-between cursor-pointer"
				>
					<div className="space-y-4">
						<div className="flex items-center gap-4 border-b border-white/5 pb-4">
							...
							<div>
								...
								<h3 className="text-base font-bold text-white tracking-widest font-mono mt-1 group-hover:text-blue-400 transition-colors">
									Meta Front-End
								</h3>
							</div>
						</div>
						...
						<div className="grid grid-cols-1 gap-3 pt-2 text-xs text-slate-300 font-mono">
							...
							<div className="flex flex-col">
								...
								<span className="text-brand-cyan mt-0.5 group-hover:underline underline-offset-4 decoration-blue-500">
									1NT0M98IZUEU ↗
								</span>
							</div>
						</div>
