import { CrewmateColor } from './components/CrewmateSprite';
...
export const INITIAL_DOORS: Door[] = [
  { id: 'door1', x: 315, y: 155, label: 'Medbay Gate', isOpen: false, w: 12, h: 45, horizontal: false },
  { id: 'door2', x: 585, y: 135, label: 'Weapons Gate', isOpen: false, w: 12, h: 45, horizontal: false },
  { id: 'door3', x: 150, y: 155, label: 'Upper Engine Gate', isOpen: false, w: 12, h: 45, horizontal: false },
  { id: 'door4', x: 155, y: 335, label: 'Security Gate', isOpen: false, w: 12, h: 45, horizontal: false },
  { id: 'door5', x: 325, y: 512, label: 'Electrical Gate', isOpen: false, w: 12, h: 45, horizontal: false },
  { id: 'door6', x: 590, y: 520, label: 'Comms Gate', isOpen: false, w: 12, h: 45, horizontal: false },
];

export const isWalkable = (x: number, y: number, doorsArray: Door[] = []): boolean => {
