...
const improveStyling = (filePath) => {
  ...
  content = content.replace(
    ...
    'bg-[#12121e]/90 backdrop-blur-xl border border-white/5 rounded-2xl p-6 hover:border-$1-500/40 hover:bg-[#1a1a2e] transition-all duration-300 group shadow-lg shadow-$1-900/10'
  );
