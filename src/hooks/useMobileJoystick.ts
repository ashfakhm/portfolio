...
export function useMobileJoystick() {
  const {
    ...
    useShallow((state) => ({
      ...
      setJoystickActive: state.setJoystickActive,
      joystickOffset: state.joystickOffset,
      setJoystickOffset: state.setJoystickOffset,
      joystickCenter: state.joystickCenter,
      setJoystickCenter: state.setJoystickCenter,
      joystickCurrent: state.joystickCurrent,
      setJoystickCurrent: state.setJoystickCurrent,
    })),
  );
